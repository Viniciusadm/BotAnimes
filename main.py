...
for i in range(0, count):
    ...
    chrome.access(f'https://betteranime.net/anime/{audio}/{anime}/episodio-{currentContext}/download')
    ...
    currentContext = nextEpisode(currentContext)
...
for i in range(0, count):
    ...
    nameFile = f'[BetterAnime.net]Detective_Conan(Episodio {currentContext}).mp4'

    files.renameFile('Detective Conan', currentContext, nameFile)
